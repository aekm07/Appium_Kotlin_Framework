...
class UserSearchTest : BaseTest() {
    private val log: Logger = Logger.getLogger(UserSearchTest::class.java.name)
    @Test
    @Description("Test Description: Verify if the user can search for Team or Player")
    @Feature("Navigate")
    fun usernavigateandverifyTest() {
